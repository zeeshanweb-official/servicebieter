...
<div class="col-sm-4">
                    <div class="r-property-box">
                      <div class="r-property-detail">
                        ...
                        <span class="lable-tag">For Sale</span>
                      </div>
                        ...
                        <div class="serves-hover">
                          <div class="hover-ser">
                            ...
                            <div class="col-md-12">
                                ...
                                <i href="javascript:;" data-toggle="modal" data-target="#myModal"
                ...
                <div class="modal fade" id="myModal">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <!-- Modal Header -->
                        <div class="modal-header" style="padding-top:15px !important;">
                          <div class="headerfixed">
                            <div class="col-md-6 pl-0">
                              <h4 class="modal-title">Send as Gift</h4>
                            </div>
                            <div class="col-md-6 pl-0"></div>
                          </div>
                          <button type="button" class="close" id="closeboton" data-dismiss="modal">&times;</button>
                        </div>
  ...
  margin-bottom: 0px;">
                        ...
                        <div class="modal-body">
                          <div class="text-center" style="font-size:24px; font-weight:700; display:block">
                          ...
                          <div class="cardscontainer">
                            ...
                            <div class="paymentmethod">
                             ...
                             <svg class="svg-master" viewBox="0 0 512 512">
                                ...
                                <polygon class="svg-master-letter"
                            ...
                            <div class="paymentmethod">
                              ...
                              <polygon class="svg-paypal-letter1to3"
                              ...
                              <path class="svg-paypal-letter4to6"
                              ...
                              <polygon class="svg-paypal-letter4to6"
                            ...
                            <div class="paymentmethod">
                              <input type="radio" name="payment" id="creditcard">
                              <p class="text-green">Credit Card</p>
                                <img src="../../../assets/images/giropay.png" style="max-width: 100%">
                            </div>
                          </div>
                          <div class="formcontainer" style="border-bottom:1px solid #e4e0e0;">
                            <div class="row">
                              <div class="col-md-6" style="border-right:1px dotted #e0dcdc;padding-bottom:20px;">
                                <form>
                                  <div class="fieldcontroller">
                                    <label style="display:block; margin-bottom:0px" for="name">Surname</label>
                                    <div class="iconcontainer">
                                      <i class="fa fa-male" style="color: #555; vertical-align: start; margin-top: 9px;position: relative;left: 1px;"></i>
                                    </div>
                                    <input style="width: 200px;border-radius: 5px 5px 5px 5px;background:#ffffff;height:30px;position: relative;text-align: center;line-height:30px;" type="text" name="name" id="name" data-rule="required" data-msg="Vérifiez votre saisie sur les champs : Le champ 'Nom' doit être renseigné.">
                                  </div>
                                   <div class="fieldcontroller">
                                    <label style="display:block; margin-bottom:0px" for="name">Name</label>
                                    <div class="iconcontainer">
                                      <i class="fa fa-user" style="color: #555; vertical-align: start; margin-top: 9px;position: relative;left: 1px;"></i>
                                    </div>
                                    <input style="width: 200px;border-radius: 5px 5px 5px 5px;background:#ffffff;height:30px;position: relative;text-align: center;line-height:30px;" type="text" name="name" id="name" data-rule="required" data-msg="Vérifiez votre saisie sur les champs : Le champ 'Nom' doit être renseigné.">
                                  </div>
                                 
                                   <div class="fieldcontroller">
                                    <label style="display:block; margin-bottom:0px" for="name">Email</label>
                                    <div class="iconcontainer" style=" margin-left:-2px;">
                                      <i class="fa fa-envelope-o" style="color: #555;  vertical-align: start; margin-top: 9px;position: relative;left: 1px;"></i>
                                    </div>
                                    <input style="width: 200px;border-radius: 5px 5px 5px 5px;background:#ffffff;height:30px;position: relative;text-align: center;line-height:30px;" type="text" name="name" id="name" data-rule="required" data-msg="Vérifiez votre saisie sur les champs : Le champ 'Nom' doit être renseigné.">
                                  </div>
                              ...
                              <div class="col-md-6">
                                <form>
                                  <div class="fieldcontroller">
                                    <label style="display:block; margin-bottom:0px" for="name">City</label>
                                    <div class="iconcontainer">
                                      <i class="fa fa-building-o" style="color: #555; vertical-align: start; margin-top: 9px;position: relative;left: 1px;"></i>
                                    </div>
                                    <input style="width: 200px;border-radius: 5px 5px 5px 5px;background:#ffffff;height:30px;position: relative;text-align: center;line-height:30px;" type="text" name="name" id="name" data-rule="required" data-msg="Vérifiez votre saisie sur les champs : Le champ 'Nom' doit être renseigné.">
                                  </div>
                                   <div class="fieldcontroller">
                                    <label style="display:block; margin-bottom:0px" for="name">Post Code</label>
                                    <div class="iconcontainer">
                                      <i class="fa fa-map-marker" style="color: #555; vertical-align: start; margin-top: 9px;position: relative;left: 1px;"></i>
                                    </div>
                                    <input style="width: 200px;border-radius: 5px 5px 5px 5px;background:#ffffff;height:30px;position: relative;text-align: center;line-height:30px;" type="text" name="name" id="name" data-rule="required" data-msg="Vérifiez votre saisie sur les champs : Le champ 'Nom' doit être renseigné.">
                                  </div>
                                 
                                   <div class="fieldcontroller">
                                    <label style="display:block; margin-bottom:0px" for="name">Phone Number</label>
                                    <div class="iconcontainer" style=" margin-left:-2px;">
                                      <i class="fa fa-phone" style="color: #555;  vertical-align: start; margin-top: 9px;position: relative;left: 1px;"></i>
                                    </div>
                                    <input style="width: 200px;border-radius: 5px 5px 5px 5px;background:#ffffff;height:30px;position: relative;text-align: center;line-height:30px;" type="text" name="name" id="name" data-rule="required" data-msg="Vérifiez votre saisie sur les champs : Le champ 'Nom' doit être renseigné.">
                                  </div>
                  ...
                  <div class="col-md-12" style="padding-top:10px;text-align: center;">
                    <button type="button" class="btn btn-pay" data-dismiss="modal" style="margin:0px 20px;">Pay Now</button>
                  </div>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-header" style="padding-top:15px !important;">
                          <div class="headerfixed">
                            <div class="col-md-6 pl-0">
                              <h4 class="modal-title">Purchase Service</h4>
                            </div>
                            <div class="col-md-6 pl-0"></div>
                          </div>
                          <button type="button" class="close" id="closeboton" data-dismiss="modal">&times;</button>
                          ...
                          <div class="dateandtime">
                            ...
                            <div class="dateTime row">
                                ...
                                <div class="col-md-6">
                                  ...
                                  <input type="time" name="time" class='form-control fc' id="time">
                                </div>
                              
                            </div>
                            <div class="row">
                              <div class="col-md-12">
                                <textarea name="intro" class="textareatexts" id="intro" cols="80" rows="10" placeholder="Make an Appoinment..."></textarea>
                              </div>
                            </div>
                          </div>
                        </div>
                  <div class="col-md-12" style="padding-top:10px;text-align: center;">
                    <button type="button" class="btn btn-pay" data-dismiss="modal" style="margin:0px 20px;">Pay Now</button>
                      ...
                      <div class="r-property-price">
                        ...
                        <a  href="#" data-toggle="modal" data-target="#PurchaseOrder" class="by-now"><i data-toggle="modal" data-target="#PurchaseOrder"  class="fa fa-shopping-cart"></i> Buy now</a>
                      </div>
                    </div>
...
.svg-paypal-border{fill:#1B557D;}
.svg-paypal-letter1to3{fill:#1B557D;}
.svg-paypal-letter4to6{fill:#107DB0;}
svg.svg-sofort{top:-8px;right:8px;width:65px;height:65px;margin-left: 5px;}
.svg-sofort-line1{fill:#ee7f00;}
.svg-sofort-line2{fill:#383a41;}
.svg-sofort-fill{fill:#fff;}
@media all and (min-width:500px){svg{right:25px;width:55px;height:55px;}
svg.svg-debit{top:4px;right:27px;width:50px;height:50px;}
svg.svg-master{right:100px;}
svg.svg-sofort{top:-14px;right:15px;width:85px;height:85px;}
}
@media all and (min-width:700px){svg{top:auto !important;right:0 !important;left:0;margin:auto;bottom:10px;width:60px;height:60px;}
svg.svg-cash{bottom:5px;width:70px;height:70px;}
svg.svg-debit{width:60px;height:60px;}
svg.svg-visa{bottom:50px;width:40px;height:40px;}
svg.svg-visa{right:175px;}
.svg-visa-border,
.svg-master-border,
.svg-amex-border,
.svg-click-border,
.svg-paypal-border{display:none;}
svg.svg-master{bottom:25px;width:40px;height:40px;}
svg.svg-amex{bottom:0;width:40px;height:40px;}
svg.svg-sofort{bottom:0;width:85px;height:85px;}
svg.svg-click{bottom:-2px;width:90px;height:90px;}
svg.svg-paypal{bottom:-8px;width:100px;height:100px;}
}

.svg-amex-border{fill:#0098D0;}
.svg-amex-letter{fill:#0098D0;}
.svg-master-border{fill:#E30613;}
.svg-master-circle1{fill:#E40520;}
.svg-master-circle2{fill:#FAB31E;}
.svg-master-letter{fill:#fff;}
.svg-visa-border{fill:#005098;}
.svg-visa-letter{fill:#005098;}
.svg-visa-corner{fill:#F6A500;}
svg.svg-visa{right:125px;}
.text-green{
  font-size: 14px;
    color: green;
    line-height: 14px;
