...
import serviceInfo from "@/components/Services/BuyServices/serviceinfo"
...
export default new Router({
  ...
  routes: [
    ...
    {path: "/Product/:id",name: "serviceInfo",component: serviceInfo},
    {path: "/companyProfile",name: "comapnyProfile",component: companyProfile},
  ]
});
